...
namespace _ExcellOn_.Controllers
{
    public class ServicesController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "Id,Service_Name,Service_Price,Service_Description,Service_TaxPercentage,Service_SaleStatus,Service_PriceSale,Service_Image")] Service service, HttpPostedFileBase Image)
        {
            ...
            sv.Service_TaxPercentage = service.Service_TaxPercentage;
        ...
        public ActionResult detailteam(int? id)
        {
            ...
            List<UserInFo> userInFos = db.UserInFoes.ToList();
            List<Service> services = db.Services.ToList();
            //List<DietPlan> dietPlans = db.DietPlans.ToList();
            var Res = from o in userInFos
                      join w in services on o.ServiceId equals w.Id where o.ServiceId==id
                      /*group o by new { o.User_FullName, o.User_AboutMe, o.User_Avatar }
                       into t*/
                      select new
                      {
                          name = o.User_FullName,
                          avt = o.User_Avatar,
                          des = o.User_AboutMe
